...
@pytest.mark.parametrize(
    ...
    [
        (
                '/api/v1/films',
                {'page[number]': 1},
                {'results': 10, 'id': 'e79b49dc-a5d9-46ec-a2c6-4cead985d732'}
        ),
        (
                '/api/v1/films',
                {'page[number]': 2},
                {'results': 10, 'id': 'a0bdd4e7-84a0-4ec5-9dae-0d16371dc303'}
        ),
        (
                '/api/v1/films/search',
                {'query': 'lucas', 'page[number]': 1},
                {'results': 10, 'id': 'cadefb3c-948c-4363-9f34-864cbc6d00d4'}
        ),
        (
                '/api/v1/films/search',
                {'query': 'lucas', 'page[number]': 2},
                {'results': 10, 'id': '044beafe-fe25-4edc-95f4-adbb8979c35b'}
        ),
        (
                '/api/v1/persons',
                {'page[number]': 1},
                {'results': 50, 'id': '2871f883-e001-4848-92d0-002adbdf2547'}
        ),
        (
                '/api/v1/persons',
                {'page[number]': 2},
                {'results': 50, 'id': '26b6e17c-dc91-48f2-98d5-43c6c237ed1f'}
        ),
        (
                '/api/v1/genres',
                {'page[number]': 1},
                {'results': 10, 'id': '3d8d9bf5-0d90-4353-88ba-4ccc5d2c07ff'}
        ),
        (
                '/api/v1/genres',
                {'page[number]': 2},
                {'results': 10, 'id': 'fb58fd7f-7afd-447f-b833-e51e45e2a778'}
        ),
    ]
)
